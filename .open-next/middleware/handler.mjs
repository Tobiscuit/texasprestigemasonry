  ...
  ".next/server/edge/chunks/node_modules_340da56f._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_340da56f._.js", 28042, (e, t, r) => {
      ...
      async function u(...e10) {
        ...
        try {
          var r2;
          await (null == t4 || null == (r2 = t4.onRequestError) ? void 0 : r2.call(t4, ...e10));
        } catch (e11) {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
      ...
      try {
        Object.defineProperty(globalThis, "__import_unsupported", { value: function(e10) {
          let t4 = new Proxy(function() {
            ...
            if ("function" == typeof a2[0]) return a2[0](t4);
            throw Object.defineProperty(Error(p(e10)), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false, configurable: true });
          } });
          return new Proxy({}, { get: () => t4 });
  ...
  `);
      ...
      function w(e10) {
        var t4, r2, n2, a2, i2, o2 = [], s2 = 0;
        function d2() {
          for (; s2 < e10.length && /\s/.test(e10.charAt(s2)); ) s2 += 1;
          return s2 < e10.length;
        }
        for (; s2 < e10.length; ) {
          for (t4 = s2, i2 = false; d2(); ) if ("," === (r2 = e10.charAt(s2))) {
            for (n2 = s2, s2 += 1, d2(), a2 = s2; s2 < e10.length && "=" !== (r2 = e10.charAt(s2)) && ";" !== r2 && "," !== r2; ) s2 += 1;
            s2 < e10.length && "=" === e10.charAt(s2) ? (i2 = true, s2 = a2, o2.push(e10.substring(t4, n2)), t4 = s2) : s2 = n2 + 1;
          } else s2 += 1;
          (!i2 || s2 >= e10.length) && o2.push(e10.substring(t4, e10.length));
        }
        return o2;
      }
      function v(e10) {
        let t4 = {}, r2 = [];
        if (e10) for (let [n2, a2] of e10.entries()) "set-cookie" === n2.toLowerCase() ? (r2.push(...w(a2)), t4[n2] = 1 === r2.length ? r2[0] : r2) : t4[n2] = a2;
        return t4;
      }
      function b(e10) {
        try {
          ...
          throw Object.defineProperty(Error(`URL is malformed "${String(e10)}". Please use only absolute URLs - https://nextjs.org/docs/messages/middleware-relative-urls`, { cause: t4 }), "__NEXT_ERROR_CODE", { value: "E61", enumerable: false, configurable: true });
        }
      }
      ...
      class E {
        constructor(e10, t4) {
          this[x] = false, this[C] = t4 ? { kind: "external", function: t4 } : { kind: "internal", promises: [] };
        }
        respondWith(e10) {
      ...
      class O extends E {
        constructor(e10) {
          var t4;
          super(e10.request, null == (t4 = e10.context) ? void 0 : t4.waitUntil), this.sourcePage = e10.page;
        }
        get request() {
      ...
      function R(e10) {
        let t4 = e10.indexOf("#"), r2 = e10.indexOf("?"), n2 = r2 > -1 && (t4 < 0 || r2 < t4);
        return n2 || t4 > -1 ? { pathname: e10.substring(0, n2 ? r2 : t4), query: n2 ? e10.substring(r2, t4 > -1 ? t4 : void 0) : "", hash: t4 > -1 ? e10.slice(t4) : "" } : { pathname: e10, query: "", hash: "" };
      }
      function P(e10, t4) {
        if (!e10.startsWith("/") || !t4) return e10;
      ...
      function M(e10, t4) {
        ...
        return r2 === t4 || r2.startsWith(t4 + "/");
      }
      let L = /* @__PURE__ */ new WeakMap();
      function I(e10, t4) {
        let r2;
        if (!t4) return { pathname: e10 };
        let n2 = L.get(t4);
        n2 || (n2 = t4.map((e11) => e11.toLowerCase()), L.set(t4, n2));
        let a2 = e10.split("/", 2);
        if (!a2[1]) return { pathname: e10 };
        let i2 = a2[1].toLowerCase(), o2 = n2.indexOf(i2);
        return o2 < 0 ? { pathname: e10 } : (r2 = t4[o2], { pathname: e10 = e10.slice(r2.length + 1) || "/", detectedLocale: r2 });
      }
      let A = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
      function k(e10, t4) {
        return new URL(String(e10).replace(A, "localhost"), t4 && String(t4).replace(A, "localhost"));
      }
      let D = Symbol("NextURLInternal");
      class j {
        constructor(e10, t4, r2) {
          let n2, a2;
          "object" == typeof t4 && "pathname" in t4 || "string" == typeof t4 ? (n2 = t4, a2 = r2 || {}) : a2 = r2 || t4 || {}, this[D] = { url: k(e10, n2 ?? a2.base), options: a2, basePath: "" }, this.analyze();
        }
        analyze() {
          var e10, t4, r2, n2, a2;
          let i2 = function(e11, t5) {
            let { basePath: r3, i18n: n3, trailingSlash: a3 } = t5.nextConfig ?? {}, i3 = { pathname: e11, trailingSlash: "/" !== e11 ? e11.endsWith("/") : a3 };
            r3 && M(i3.pathname, r3) && (i3.pathname = function(e12, t6) {
              if (!M(e12, t6)) return e12;
            ...
            if (i3.pathname.startsWith("/_next/data/") && i3.pathname.endsWith(".json")) {
              ...
              i3.buildId = e12[0], o3 = "index" !== e12[1] ? `/${e12.slice(1).join("/")}` : "/", true === t5.parseData && (i3.pathname = o3);
            }
            if (n3) {
              let e12 = t5.i18nProvider ? t5.i18nProvider.analyze(i3.pathname) : I(i3.pathname, n3.locales);
              i3.locale = e12.detectedLocale, i3.pathname = e12.pathname ?? i3.pathname, !e12.detectedLocale && i3.buildId && (e12 = t5.i18nProvider ? t5.i18nProvider.analyze(o3) : I(o3, n3.locales)).detectedLocale && (i3.locale = e12.detectedLocale);
            }
            return i3;
          }(this[D].url.pathname, { nextConfig: this[D].options.nextConfig, parseData: true, i18nProvider: this[D].options.i18nProvider }), o2 = function(e11, t5) {
            let r3;
            if (t5?.host && !Array.isArray(t5.host)) r3 = t5.host.toString().split(":", 1)[0];
            else {
          ...
          this[D].domainLocale = this[D].options.i18nProvider ? this[D].options.i18nProvider.detectDomainLocale(o2) : function(e11, t5, r3) {
            if (e11) {
              for (let n3 of (r3 && (r3 = r3.toLowerCase()), e11)) if (t5 === n3.domain?.split(":", 1)[0].toLowerCase() || r3 === n3.defaultLocale.toLowerCase() || n3.locales?.some((e12) => e12.toLowerCase() === r3)) return n3;
            }
          }(null == (t4 = this[D].options.nextConfig) || null == (e10 = t4.i18n) ? void 0 : e10.domains, o2);
        ...
        formatPathname() {
          var e10;
          let t4;
          return t4 = function(e11, t5, r2, n2) {
            if (!t5 || t5 === r2) return e11;
            let a2 = e11.toLowerCase();
            return !n2 && (M(a2, "/api") || M(a2, `/${t5.toLowerCase()}`)) ? e11 : P(e11, `/${t5}`);
          }((e10 = { basePath: this[D].basePath, buildId: this[D].buildId, defaultLocale: this[D].options.forceLocale ? void 0 : this[D].defaultLocale, locale: this[D].locale, pathname: this[D].url.pathname, trailingSlash: this[D].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t4 = T(t4)), e10.buildId && (t4 = N(P(t4, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t4 = P(t4, e10.basePath), !e10.buildId && e10.trailingSlash ? t4.endsWith("/") ? t4 : N(t4, "/") : T(t4);
        }
        formatSearch() {
        ...
        set locale(e10) {
          var t4, r2;
          if (!this[D].locale || !(null == (r2 = this[D].options.nextConfig) || null == (t4 = r2.i18n) ? void 0 : t4.locales.includes(e10))) throw Object.defineProperty(TypeError(`The NextURL configuration includes no locale "${e10}"`), "__NEXT_ERROR_CODE", { value: "E597", enumerable: false, configurable: true });
          this[D].locale = e10;
        }
        get defaultLocale() {
        ...
        get href() {
          let e10 = this.formatPathname(), t4 = this.formatSearch();
          return `${this.protocol}//${this.host}${e10}${t4}${this.hash}`;
        }
        set href(e10) {
      ...
      class en extends Request {
        constructor(e10, t4 = {}) {
          ...
          b(r2), e10 instanceof Request ? super(e10, t4) : super(r2, t4);
          const n2 = new j(r2, { headers: v(this.headers), nextConfig: t4.nextConfig });
      ...
      class ea {
        static get(e10, t4, r2) {
          let n2 = Reflect.get(e10, t4, r2);
          return "function" == typeof n2 ? n2.bind(e10) : n2;
        }
        static set(e10, t4, r2, n2) {
          return Reflect.set(e10, t4, r2, n2);
        }
        static has(e10, t4) {
          return Reflect.has(e10, t4);
        }
        static deleteProperty(e10, t4) {
          return Reflect.deleteProperty(e10, t4);
        }
      }
      ...
      function es(e10, t4) {
        ...
        if (null == e10 || null == (r2 = e10.request) ? void 0 : r2.headers) {
          ...
          let r3 = [];
          for (let [n2, a2] of e10.request.headers) t4.set("x-middleware-request-" + n2, a2), r3.push(n2);
          t4.set("x-middleware-override-headers", r3.join(","));
        }
      }
      class ed extends Response {
            ...
            switch (n3) {
              ...
              case "set":
                return (...a3) => {
                  ...
                  return i2 instanceof et.ResponseCookies && r2.set("x-middleware-set-cookie", i2.getAll().map((e12) => (0, et.stringifyCookie)(e12)).join(",")), es(t4, o2), i2;
                };
              default:
                return ea.get(e11, n3, a2);
            }
          } });
          this[ei] = { cookies: n2, url: t4.url ? new j(t4.url, { headers: v(r2), nextConfig: t4.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static json(e10, t4) {
          let r2 = Response.json(e10, t4);
          return new ed(r2.body, r2);
        }
        static redirect(e10, t4) {
          let r2 = "number" == typeof t4 ? t4 : (null == t4 ? void 0 : t4.status) ?? 307;
          ...
          let n2 = "object" == typeof t4 ? t4 : {}, a2 = new Headers(null == n2 ? void 0 : n2.headers);
          return a2.set("Location", b(e10)), new ed(null, { ...n2, headers: a2, status: r2 });
        }
        static rewrite(e10, t4) {
          let r2 = new Headers(null == t4 ? void 0 : t4.headers);
          return r2.set("x-middleware-rewrite", b(e10)), es(t4, r2), new ed(null, { ...t4, headers: r2 });
        }
        static next(e10) {
          let t4 = new Headers(null == e10 ? void 0 : e10.headers);
          return t4.set("x-middleware-next", "1"), es(e10, t4), new ed(null, { ...e10, headers: t4 });
        }
      }
      function el(e10, t4) {
        let r2 = "string" == typeof t4 ? new URL(t4) : t4, n2 = new URL(e10, t4), a2 = n2.origin === r2.origin;
      ...
      class ef extends Headers {
        constructor(e10) {
          super(), this.headers = new Proxy(e10, { get(t4, r2, n2) {
            if ("symbol" == typeof r2) return ea.get(t4, r2, n2);
            let a2 = r2.toLowerCase(), i2 = Object.keys(e10).find((e11) => e11.toLowerCase() === a2);
            if (void 0 !== i2) return ea.get(t4, i2, n2);
          }, set(t4, r2, n2, a2) {
            if ("symbol" == typeof r2) return ea.set(t4, r2, n2, a2);
            let i2 = r2.toLowerCase(), o2 = Object.keys(e10).find((e11) => e11.toLowerCase() === i2);
            return ea.set(t4, o2 ?? r2, n2, a2);
          }, has(t4, r2) {
            if ("symbol" == typeof r2) return ea.has(t4, r2);
            let n2 = r2.toLowerCase(), a2 = Object.keys(e10).find((e11) => e11.toLowerCase() === n2);
            return void 0 !== a2 && ea.has(t4, a2);
          }, deleteProperty(t4, r2) {
            if ("symbol" == typeof r2) return ea.deleteProperty(t4, r2);
            let n2 = r2.toLowerCase(), a2 = Object.keys(e10).find((e11) => e11.toLowerCase() === n2);
            return void 0 === a2 || ea.deleteProperty(t4, a2);
          } });
        }
        static seal(e10) {
          return new Proxy(e10, { get(e11, t4, r2) {
            switch (t4) {
              case "append":
              case "delete":
              case "set":
        ...
        append(e10, t4) {
          ...
          "string" == typeof r2 ? this.headers[e10] = [r2, t4] : Array.isArray(r2) ? r2.push(t4) : this.headers[e10] = t4;
        }
        delete(e10) {
          delete this.headers[e10];
        }
        get(e10) {
          let t4 = this.headers[e10];
          return void 0 !== t4 ? this.merge(t4) : null;
        }
        has(e10) {
        ...
        forEach(e10, t4) {
          for (let [r2, n2] of this.entries()) e10.call(t4, n2, r2, this);
        }
        *entries() {
          for (let e10 of Object.keys(this.headers)) {
            let t4 = e10.toLowerCase(), r2 = this.get(t4);
            yield [t4, r2];
          }
        }
        *keys() {
          for (let e10 of Object.keys(this.headers)) {
            let t4 = e10.toLowerCase();
            yield t4;
          }
        }
        *values() {
      ...
      class ex {
        static wrap(e10, t4) {
          ...
          let n2 = [], a2 = /* @__PURE__ */ new Set(), i2 = () => {
            let e11 = ew.getStore();
            if (e11 && (e11.pathWasRevalidated = 1), n2 = r2.getAll().filter((e12) => a2.has(e12.name)), t4) {
              let e12 = [];
              for (let t5 of n2) {
          ...
          }, o2 = new Proxy(r2, { get(e11, t5, r3) {
            switch (t5) {
              case eS:
                return n2;
              case "delete":
                return function(...t6) {
                  a2.add("string" == typeof t6[0] ? t6[0] : t6[0].name);
                  try {
                    return e11.delete(...t6), o2;
                  } finally {
                    i2();
                  }
                };
              case "set":
                return function(...t6) {
                  a2.add("string" == typeof t6[0] ? t6[0] : t6[0].name);
                  try {
                    return e11.set(...t6), o2;
                  } finally {
                    i2();
                  }
                };
              default:
                return ea.get(e11, t5, r3);
            }
          } });
          return o2;
        }
      ...
      class eW extends Error {
        constructor(e10, t4) {
          super(), this.bubble = e10, this.result = t4;
        }
      }
      let eF = (e10, t4) => {
        "object" == typeof t4 && null !== t4 && t4 instanceof eW && t4.bubble ? e10.setAttribute("next.bubble", true) : (t4 && (e10.recordException(t4), e10.setAttribute("error.type", t4.name)), e10.setStatus({ code: e$.ERROR, message: null == t4 ? void 0 : t4.message })), e10.end();
      }, eX = /* @__PURE__ */ new Map(), eZ = t.createContextKey("next.rootSpanId"), eY = 0, eJ = { set(e10, t4, r2) {
        e10.push({ key: t4, value: r2 });
      } }, eQ = (n = new class e {
        getTracerInstance() {
        ...
        getTracePropagationData() {
          let e10 = eG.active(), t4 = [];
          return eV.inject(e10, t4, eJ), t4;
        }
        getActiveScopeSpan() {
          return eH.getSpan(null == eG ? void 0 : eG.active());
        }
        withPropagatedContext(e10, t4, r2) {
          let n2 = eG.active();
          if (eH.getSpanContext(n2)) return t4();
          let a2 = eV.extract(n2, e10, r2);
          return eG.with(a2, t4);
        }
        trace(...e10) {
          let [t4, r2, n2] = e10, { fn: a2, options: i2 } = "function" == typeof r2 ? { fn: r2, options: {} } : { fn: n2, options: { ...r2 } }, o2 = i2.spanName ?? t4;
          if (!ej.has(t4) && "1" !== process.env.NEXT_OTEL_VERBOSE || i2.hideSpan) return a2();
          ...
          return i2.attributes = { "next.span_name": o2, "next.span_type": t4, ...i2.attributes }, eG.with(s2.setValue(eZ, u2), () => this.getTracerInstance().startActiveSpan(o2, i2, (e11) => {
            let r3;
            eU && t4 && eq.has(t4) && (r3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0);
            let n3 = false, o3 = () => {
              !n3 && (n3 = true, eX.delete(u2), r3 && performance.measure(`${eU}:next-${(t4.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: r3, end: performance.now() }));
            };
            if (l2 && eX.set(u2, new Map(Object.entries(i2.attributes ?? {}))), a2.length > 1) try {
              return a2(e11, (t5) => eF(e11, t5));
            } catch (t5) {
              throw eF(e11, t5), t5;
            } finally {
              o3();
            ...
            try {
              let t5 = a2(e11);
              if (eB(t5)) return t5.then((t6) => (e11.end(), t6)).catch((t6) => {
                throw eF(e11, t6), t6;
              }).finally(o3);
              return e11.end(), o3(), t5;
            } catch (t5) {
              throw eF(e11, t5), o3(), t5;
            }
          }));
        }
        wrap(...e10) {
          let t4 = this, [r2, n2, a2] = 3 === e10.length ? e10 : [e10[0], {}, e10[1]];
          return ej.has(r2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            ...
            if ("function" != typeof o2) return t4.trace(r2, e11, () => a2.apply(this, arguments));
            {
              let n3 = t4.getContext().bind(eG.active(), o2);
              return t4.trace(r2, e11, (e12, t5) => (arguments[i2] = function(e13) {
        ...
        startSpan(...e10) {
          let [t4, r2] = e10, n2 = this.getSpanContext((null == r2 ? void 0 : r2.parentSpan) ?? this.getActiveScopeSpan());
          return this.getTracerInstance().startSpan(t4, r2, n2);
        }
        getSpanContext(e10) {
      ...
      class e1 {
        constructor(e10, t4, r2, n2) {
          ...
          }(t4, e10).isOnDemandRevalidate, o2 = null == (a2 = r2.get(e0)) ? void 0 : a2.value;
      ...
      function e3(e10, t4) {
        if ("x-middleware-set-cookie" in e10.headers && "string" == typeof e10.headers["x-middleware-set-cookie"]) {
          ...
          for (let e11 of new et.ResponseCookies(n2).getAll()) t4.set(e11);
        }
      }
      let e2 = em();
      class e4 extends Error {
        constructor(e10, t4) {
          super(`Invariant: ${e10.endsWith(".") ? e10 : e10 + "."} This is a bug in Next.js.`, t4), this.name = "InvariantError";
        }
      }
      var e5 = e.i(99734);
      e.i(51615);
      ...
      async function te(e10, t4) {
        ...
        try {
          ...
          var n2, a2;
          let t5, i2, o2 = (n2 = r2, a2 = tt(e10), t5 = new Set(n2.pendingRevalidatedTags.map((e11) => {
            let t6 = "object" == typeof e11.profile ? JSON.stringify(e11.profile) : e11.profile || "";
            return `${e11.tag}:${t6}`;
      ...
      async function tr(e10, t4, r2) {
        if (0 === e10.length) return;
        let n2 = function() {
          if (e7[e6]) return e7[e6].values();
        }(), a2 = [], i2 = /* @__PURE__ */ new Map();
        for (let t5 of e10) {
          let e11, r3 = t5.profile;
          for (let [t6] of i2) if ("string" == typeof t6 && "string" == typeof r3 && t6 === r3 || "object" == typeof t6 && "object" == typeof r3 && JSON.stringify(t6) === JSON.stringify(r3) || t6 === r3) {
            e11 = t6;
            break;
          }
          let n3 = e11 || r3;
          i2.has(n3) || i2.set(n3, []), i2.get(n3).push(t5.tag);
        }
        for (let [e11, s2] of i2) {
          let i3;
          if (e11) {
            let t5;
            if ("object" == typeof e11) t5 = e11;
            else if ("string" == typeof e11) {
              var o2;
              if (!(t5 = null == r2 || null == (o2 = r2.cacheLifeProfiles) ? void 0 : o2[e11])) throw Object.defineProperty(Error(`Invalid profile provided "${e11}" must be configured under cacheLife in next.config or be "max"`), "__NEXT_ERROR_CODE", { value: "E873", enumerable: false, configurable: true });
            }
            t5 && (i3 = { expire: t5.expire });
          }
          for (let t5 of n2 || []) e11 ? a2.push(null == t5.updateTags ? void 0 : t5.updateTags.call(t5, s2, i3)) : a2.push(null == t5.updateTags ? void 0 : t5.updateTags.call(t5, s2));
          t4 && a2.push(t4.revalidateTag(s2, i3));
        }
        await Promise.all(a2);
      }
      async function tn(e10, t4) {
        let r2 = (null == t4 ? void 0 : t4.pendingRevalidatedTags) ?? e10.pendingRevalidatedTags ?? [], n2 = (null == t4 ? void 0 : t4.pendingRevalidates) ?? e10.pendingRevalidates ?? {}, a2 = (null == t4 ? void 0 : t4.pendingRevalidateWrites) ?? e10.pendingRevalidateWrites ?? [];
        return Promise.all([tr(r2, e10.incrementalCache, e10), ...Object.values(n2), ...a2]);
      }
      let ta = em();
      class ti {
        constructor({ waitUntil: e10, onClose: t4, onTaskError: r2 }) {
          this.workUnitStores = /* @__PURE__ */ new Set(), this.waitUntil = e10, this.onClose = t4, this.onTaskError = r2, this.callbackQueue = new e5.default(), this.callbackQueue.pause();
        }
        after(e10) {
        ...
        reportTaskError(e10, t4) {
          if (console.error("promise" === e10 ? "A promise passed to `after()` rejected:" : "An error occurred in a function passed to `after()`:", t4), this.onTaskError) try {
            null == this.onTaskError || this.onTaskError.call(this, t4);
          } catch (e11) {
      ...
      function ts(e10) {
        let t4, r2 = { then: (n2, a2) => (t4 || (t4 = Promise.resolve(e10())), t4.then((e11) => {
          r2.value = e11;
        }).catch(() => {
        }), t4.then(n2, a2)) };
        return r2;
      ...
      async function tc(e10, t4, r2) {
        ...
        for (let t5 of ((e11) => {
          ...
          return t6;
        })(e10)) t5 = `${y}${t5}`, n2.add(t5);
        if (t4.pathname && (!r2 || 0 === r2.size)) {
          let e11 = `${y}${t4.pathname}`;
          n2.add(e11);
        }
        n2.has(`${y}/`) && n2.add(`${y}/index`), n2.has(`${y}/index`) && n2.add(`${y}/`);
        let a2 = Array.from(n2);
        return { tags: a2, expirationsByCacheKind: function(e11) {
          let t5 = /* @__PURE__ */ new Map(), r3 = e8();
          if (r3) for (let [n3, a3] of r3) "getExpiration" in a3 && t5.set(n3, ts(async () => a3.getExpiration(e11)));
          return t5;
        }(a2) };
      }
      class t_ extends en {
      ...
      let tp = { keys: (e10) => Array.from(e10.keys()), get: (e10, t4) => e10.get(t4) ?? void 0 }, tf = (e10, t4) => eQ().withPropagatedContext(e10.headers, t4, tp), th = false;
      async function tg(t4) {
        var r2, n2, a2, i2;
        let o2, s2, d2, l2, u2;
        !function() {
        ...
        t4.request.url = t4.request.url.replace(/\.rsc($|\?)/, "$1");
        let p2 = t4.bypassNextUrl ? new URL(t4.request.url) : new j(t4.request.url, { headers: t4.request.headers, nextConfig: t4.request.nextConfig });
        for (let e10 of [...p2.searchParams.keys()]) {
          let t5 = p2.searchParams.getAll(e10), r3 = function(e11) {
            for (let t6 of ["nxtP", "nxtI"]) if (e11 !== t6 && e11.startsWith(t6)) return e11.substring(t6.length);
            return null;
          }(e10);
          if (r3) {
            for (let e11 of (p2.searchParams.delete(r3), t5)) p2.searchParams.append(r3, e11);
        ...
        let h2 = function(e10) {
          ...
          return t5;
        }(t4.request.headers), g2 = h2.has("x-nextjs-data"), y2 = "1" === h2.get("rsc");
        g2 && "/index" === p2.pathname && (p2.pathname = "/");
        let m2 = /* @__PURE__ */ new Map();
        if (!c2) for (let e10 of ec) {
          let t5 = h2.get(e10);
          null !== t5 && (m2.set(e10, t5), h2.delete(e10));
        }
        let w2 = p2.searchParams.get(e_), v2 = new t_({ page: t4.page, input: ((l2 = (d2 = "string" == typeof p2) ? new URL(p2) : p2).searchParams.delete(e_), d2 ? l2.toString() : l2).toString(), init: { body: t4.request.body, headers: h2, method: t4.request.method, nextConfig: t4.request.nextConfig, signal: t4.request.signal } });
        g2 && Object.defineProperty(v2, "__isData", { enumerable: false, value: true }), !globalThis.__incrementalCacheShared && t4.IncrementalCache && (globalThis.__incrementalCache = new t4.IncrementalCache({ CurCacheHandler: t4.incrementalCacheHandler, minimalMode: true, fetchCacheKeyPrefix: "", dev: false, requestHeaders: t4.request.headers, getPrerenderManifest: () => ({ version: -1, routes: {}, dynamicRoutes: {}, notFoundRoutes: [], preview: tl() }) }));
        let b2 = t4.request.waitUntil ?? (null == (r2 = null == (u2 = globalThis[tu]) ? void 0 : u2.get()) ? void 0 : r2.waitUntil), S2 = new O({ request: v2, page: t4.page, context: b2 ? { waitUntil: b2 } : void 0 });
        if ((o2 = await tf(v2, () => {
          if ("/middleware" === t4.page || "/src/middleware" === t4.page || "/proxy" === t4.page || "/src/proxy" === t4.page) {
            ...
            return eQ().trace(eD.execute, { spanName: `middleware ${v2.method}`, attributes: { "http.target": v2.nextUrl.pathname, "http.method": v2.method } }, async () => {
              try {
                ...
                let u3 = tl(), c3 = await tc("/", v2.nextUrl, null), _2 = (d3 = v2.nextUrl, l3 = (e11) => {
                  s2 = e11;
                }, function(e11, t5, r4, n4, a4, i4, o4, s3, d4, l4, u4, c4) {
                  function _3(e12) {
                  ...
                  return { type: "request", phase: e11, implicitTags: i4, url: { pathname: n4.pathname, search: n4.search ?? "" }, rootParams: a4, get headers() {
                    return p4.headers || (p4.headers = function(e12) {
                      let t6 = ef.from(e12);
                      for (let e13 of ec) t6.delete(e13);
                      return ef.seal(t6);
                    }(t5.headers)), p4.headers;
                  }, get cookies() {
                    if (!p4.cookies) {
                      let e12 = new et.RequestCookies(ef.from(t5.headers));
                      e3(t5, e12), p4.cookies = eb.seal(e12);
                    }
                    return p4.cookies;
                  }, set cookies(value) {
                    p4.cookies = value;
                    ...
                    if (!p4.mutableCookies) {
                      var f3, h3;
                      let e12, n5 = (f3 = t5.headers, h3 = o4 || (r4 ? _3 : void 0), e12 = new et.RequestCookies(ef.from(f3)), ex.wrap(e12, h3));
                      e3(t5, n5), p4.mutableCookies = n5;
                    }
                    ...
                    if (!p4.userspaceMutableCookies) {
                      var g3;
                      let e12;
                      g3 = this, p4.userspaceMutableCookies = e12 = new Proxy(g3.mutableCookies, { get(t6, r5, n5) {
                        switch (r5) {
                          case "delete":
                            return function(...r6) {
                              return eC(g3, "cookies().delete"), t6.delete(...r6), e12;
                            };
                          case "set":
                            return function(...r6) {
                              return eC(g3, "cookies().set"), t6.set(...r6), e12;
                            };
                          default:
                            return ea.get(t6, r5, n5);
                        }
                      } });
                    }
                    return p4.userspaceMutableCookies;
                  }, get draftMode() {
                    return p4.draftMode || (p4.draftMode = new e1(d4, t5, this.cookies, this.mutableCookies)), p4.draftMode;
                ...
                }("action", v2, void 0, d3, {}, c3, l3, null, u3, false, void 0, null)), p3 = function({ page: e11, renderOpts: t5, isPrefetchRequest: r4, buildId: n4, previouslyRevalidatedTags: a4, nonce: i4 }) {
                  var o4;
                  let s3 = !t5.shouldWaitOnAllReady && !t5.supportsDynamicResponse && !t5.isDraftMode && !t5.isPossibleServerAction, d4 = t5.dev ?? false, l4 = d4 || s3 && (!!process.env.NEXT_DEBUG_BUILD || "1" === process.env.NEXT_SSG_FETCH_METRICS), u4 = { isStaticGeneration: s3, page: e11, route: (o4 = e11.split("/").reduce((e12, t6, r5, n5) => t6 ? "(" === t6[0] && t6.endsWith(")") || "@" === t6[0] || ("page" === t6 || "route" === t6) && r5 === n5.length - 1 ? e12 : `${e12}/${t6}` : e12, "")).startsWith("/") ? o4 : `/${o4}`, incrementalCache: t5.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: t5.cacheLifeProfiles, isBuildTimePrerendering: t5.nextExport, hasReadableErrorStacks: t5.hasReadableErrorStacks, fetchCache: t5.fetchCache, isOnDemandRevalidate: t5.isOnDemandRevalidate, isDraftMode: t5.isDraftMode, isPrefetchRequest: r4, buildId: n4, reactLoadableManifest: (null == t5 ? void 0 : t5.reactLoadableManifest) || {}, assetPrefix: (null == t5 ? void 0 : t5.assetPrefix) || "", nonce: i4, afterContext: function(e12) {
                    let { waitUntil: t6, onClose: r5, onAfterTaskError: n5 } = e12;
                    return new ti({ waitUntil: t6, onClose: r5, onTaskError: n5 });
                  }(t5), cacheComponentsEnabled: t5.cacheComponents, dev: d4, previouslyRevalidatedTags: a4, refreshTagsByCacheKind: function() {
                    let e12 = /* @__PURE__ */ new Map(), t6 = e8();
                    if (t6) for (let [r5, n5] of t6) "refreshTags" in n5 && e12.set(r5, ts(async () => n5.refreshTags()));
                    return e12;
                  }(), runInCleanSnapshot: ey ? ey.snapshot() : function(e12, ...t6) {
                    return e12(...t6);
                  }, shouldTrackFetchMetrics: l4, reactServerErrorsByDigest: /* @__PURE__ */ new Map() };
                  return t5.store = u4, u4;
                }({ page: "/", renderOpts: { cacheLifeProfiles: null == (a3 = t4.request.nextConfig) || null == (n3 = a3.experimental) ? void 0 : n3.cacheLife, cacheComponents: false, experimental: { isRoutePPREnabled: false, authInterrupts: !!(null == (o3 = t4.request.nextConfig) || null == (i3 = o3.experimental) ? void 0 : i3.authInterrupts) }, supportsDynamicResponse: true, waitUntil: e10, onClose: r3.onClose.bind(r3), onAfterTaskError: void 0 }, isPrefetchRequest: "1" === v2.headers.get(eu), buildId: f2 ?? "", previouslyRevalidatedTags: [] });
                return await ew.run(p3, () => e2.run(_2, t4.handler, v2, S2));
              } finally {
                setTimeout(() => {
                  r3.dispatchClose();
                }, 0);
        ...
        if (o2 && x2 && (y2 || !c2)) {
          let e10 = new j(x2, { forceLocale: true, headers: t4.request.headers, nextConfig: t4.request.nextConfig });
          ...
          let d3 = !s3 && (null == (i2 = t4.request.nextConfig) || null == (a2 = i2.experimental) || null == (n2 = a2.clientParamParsingOrigins) ? void 0 : n2.some((t5) => new RegExp(t5).test(e10.origin)));
        ...
        if (o2 && E2 && !c2) {
          let e10 = new j(E2, { forceLocale: false, headers: t4.request.headers, nextConfig: t4.request.nextConfig });
        ...
        if (R2) {
          for (let [e10, t5] of m2) T2.headers.set(`x-middleware-request-${e10}`, t5), P2.push(e10);
      ...
      function tm(e10, t4, r2) {
        return "string" == typeof e10 ? e10 : e10[t4] || r2;
      }
      function tw(e10) {
        let t4 = function() {
          try {
        ...
        if ("/" !== i2) {
          let e11 = i2.endsWith("/");
          t4 && !e11 ? i2 += "/" : !t4 && e11 && (i2 = i2.slice(0, -1));
        }
        return a2 && (i2 += "#" + a2), i2;
      }
      function tv(e10, t4) {
        let r2 = tw(e10), n2 = tw(t4);
        return tS(r2).test(n2);
      }
      function tb(e10, t4) {
        return "never" !== t4.mode && t4.prefixes?.[e10] || "/" + e10;
      }
      function tS(e10) {
        let t4 = e10.replace(/\/\[\[(\.\.\.[^\]]+)\]\]/g, "(?:/(.*))?").replace(/\[\[(\.\.\.[^\]]+)\]\]/g, "(?:/(.*))?").replace(/\[(\.\.\.[^\]]+)\]/g, "(.+)").replace(/\[([^\]]+)\]/g, "([^/]+)");
        return RegExp(`^${t4}$`);
      }
      function tx(e10) {
        return e10.includes("[[...");
      ...
      function tO(e10, t4) {
        let r2 = e10.split("/"), n2 = t4.split("/"), a2 = Math.max(r2.length, n2.length);
        for (let e11 = 0; e11 < a2; e11++) {
          let t5 = r2[e11], a3 = n2[e11];
          if (!t5 && a3) return -1;
          if (t5 && !a3) return 1;
          if (t5 || a3) {
            if (!tE(t5) && tE(a3)) return -1;
            if (tE(t5) && !tE(a3)) return 1;
            if (!tC(t5) && tC(a3)) return -1;
            if (tC(t5) && !tC(a3)) return 1;
            if (!tx(t5) && tx(a3)) return -1;
            if (tx(t5) && !tx(a3)) return 1;
          }
        }
        return 0;
      }
      function tT(e10, t4, r2, n2) {
        let a2 = "";
        return a2 += function(e11, t5) {
          if (!t5) return e11;
          let r3 = e11 = e11.replace(/\[\[/g, "[").replace(/\]\]/g, "]");
          return Object.entries(t5).forEach(([e12, t6]) => {
            r3 = r3.replace(`[${e12}]`, t6);
          }), r3;
        }(r2, function(e11, t5) {
          let r3 = tw(t5), n3 = tw(e11), a3 = tS(n3).exec(r3);
          if (!a3) return;
          let i2 = {}, o2 = n3.match(/\[([^\]]+)\]/g) ?? [];
          for (let e12 = 1; e12 < a3.length; e12++) {
            let t6 = o2[e12 - 1];
            if (!t6) continue;
            let r4 = t6.replace(/[[\]]/g, ""), n4 = a3[e12] ?? "";
            i2[r4] = n4;
          }
          return i2;
        }(t4, e10)), a2 = tw(a2);
      }
      function tR(e10, t4, r2) {
        e10.endsWith("/") || (e10 += "/");
        let n2 = tP(t4, r2), a2 = RegExp(`^(${n2.map(([, e11]) => e11.replaceAll("/", "\\/")).join("|")})/(.*)`, "i"), i2 = e10.match(a2), o2 = i2 ? "/" + i2[2] : e10;
        return "/" !== o2 && (o2 = tw(o2)), o2;
      }
      function tP(e10, t4, r2 = true) {
        let n2 = e10.map((e11) => [e11, tb(e11, t4)]);
        return r2 && n2.sort((e11, t5) => t5[1].length - e11[1].length), n2;
      }
      function tN(e10, t4, r2, n2) {
        let a2 = tP(t4, r2);
        for (let [t5, r3] of (n2 && a2.sort(([e11], [t6]) => {
          if (e11 === n2.defaultLocale) return -1;
          if (t6 === n2.defaultLocale) return 1;
          let r4 = n2.locales.includes(e11), a3 = n2.locales.includes(t6);
          return r4 && !a3 ? -1 : !r4 && a3 ? 1 : 0;
        }), a2)) {
          let n3, a3;
          if (e10 === r3 || e10.startsWith(r3 + "/")) n3 = a3 = true;
          else {
            let t6 = e10.toLowerCase(), i2 = r3.toLowerCase();
            (t6 === i2 || t6.startsWith(i2 + "/")) && (n3 = false, a3 = true);
          }
          if (a3) return { locale: t5, prefix: r3, matchedPrefix: e10.slice(0, r3.length), exact: n3 };
        }
      }
      function tM(e10, t4, r2) {
        var n2;
        let a2, i2 = e10;
        return t4 && (n2 = i2, a2 = t4, /^\/(\?.*)?$/.test(n2) && (n2 = n2.slice(1)), i2 = a2 += n2), r2 && (i2 += r2), i2;
      }
      function tL(e10) {
        return e10.get("x-forwarded-host") ?? e10.get("host") ?? void 0;
      }
      function tI(e10, t4) {
        return t4.defaultLocale === e10 || t4.locales.includes(e10);
      }
      function tA(e10, t4, r2) {
        let n2;
        return e10 && tI(t4, e10) && (n2 = e10), n2 || (n2 = r2.find((e11) => e11.defaultLocale === t4)), n2 || (n2 = r2.find((e11) => e11.locales.includes(t4))), n2;
      }
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), e.s([], 85835), e.i(85835);
      function tk(e10, t4, r2, n2) {
        let a2 = null == n2 || "number" == typeof n2 || "boolean" == typeof n2 ? n2 : r2(n2), i2 = t4.get(a2);
        return void 0 === i2 && (i2 = e10.call(this, n2), t4.set(a2, i2)), i2;
      }
      function tD(e10, t4, r2) {
        let n2 = Array.prototype.slice.call(arguments, 3), a2 = r2(n2), i2 = t4.get(a2);
        return void 0 === i2 && (i2 = e10.apply(this, n2), t4.set(a2, i2)), i2;
      }
      class tj {
        cache;
        constructor() {
      ...
      function tG(e10, t4, r2 = Error) {
        if (!e10) throw new r2(t4);
      }
      function tV(e10, t4, r2) {
        let [n2, a2, i2] = t4.split("-"), o2 = true;
        if (i2 && "$" === i2[0]) {
          let t5 = "!" !== i2[1], n3 = (t5 ? r2[i2.slice(1)] : r2[i2.slice(2)]).map((e11) => tB[e11] || [e11]).reduce((e11, t6) => [...e11, ...t6], []);
          o2 &&= n3.indexOf(e10.region || "") > -1 == t5;
      ...
      function t$(e10, t4, r2) {
        for (let n2 of r2.matches) {
          let a2 = tV(e10, n2.desired, r2.matchVariables) && tV(t4, n2.supported, r2.matchVariables);
          if (n2.oneway || a2 || (a2 = tV(e10, n2.supported, r2.matchVariables) && tV(t4, n2.desired, r2.matchVariables)), a2) {
            let a3 = 10 * n2.distance;
            if (r2.paradigmLocales.indexOf(tH(e10)) > -1 != r2.paradigmLocales.indexOf(tH(t4)) > -1) return a3 - 1;
            return a3;
          }
        }
        throw Error("No matching distance found");
      }
      let tK = (Z = function(e10, t4) {
        let n2 = new Intl.Locale(e10).maximize(), a2 = new Intl.Locale(t4).maximize(), i2 = { language: n2.language, script: n2.script || "", region: n2.region || "" }, o2 = { language: a2.language, script: a2.script || "", region: a2.region || "" }, s2 = 0, d2 = function() {
          if (!r) {
            let e11 = tq["written-new"][0]?.paradigmLocales?._locales.split(" "), t5 = tq["written-new"].slice(1, 5);
            r = { matches: tq["written-new"].slice(5).map((e12) => {
              let t6 = Object.keys(e12)[0], r2 = e12[t6];
              return { supported: t6, desired: r2._desired, distance: +r2._distance, oneway: "true" === r2.oneway };
            }, {}), matchVariables: t5.reduce((e12, t6) => {
              let r2 = Object.keys(t6)[0], n3 = t6[r2];
      ...
      }, (Y && Y.strategy ? Y.strategy : function(e10, t4) {
        var r2, n2;
        let a2 = 1 === e10.length ? tk : tD;
        return r2 = t4.cache.create(), n2 = t4.serializer, a2.bind(this, e10, r2, n2);
      ...
      var tX = e.i(29300);
      function tZ(e10, t4, r2) {
        let n2, a2 = new tX.default({ headers: { "accept-language": e10.get("accept-language") || void 0 } }).languages();
        try {
          var i2;
          let e11 = t4.slice().sort((e12, t5) => t5.length - e12.length);
          i2 = function(e12, t5, r3, n3, a3, i3) {
            let o2, s2;
            if ("lookup" === r3.localeMatcher) o2 = function(e13, t6, r4) {
              let n4 = { locale: "" };
              for (let r5 of t6) {
                let t7 = r5.replace(tU, ""), a4 = function(e14, t8) {
                  let r6 = tF.get(e14);
                ...
                if (a4) return n4.locale = a4, r5 !== t7 && (n4.extension = r5.slice(t7.length, r5.length)), n4;
              }
              return n4.locale = r4(), n4;
            }(Array.from(e12), t5, i3);
            else {
              var d2;
              let r4, n4, a4, s3, l3;
              d2 = Array.from(e12), a4 = [], s3 = t5.reduce((e13, t6) => {
                let r5 = t6.replace(tU, "");
                return a4.push(r5), e13[r5] = t6, e13;
              }, {}), (l3 = function(e13, t6, r5 = 838) {
                let n5 = 1 / 0, a5 = { matchedDesiredLocale: "", distances: {} }, i4 = tz.get(t6);
                i4 || (i4 = t6.map((e14) => {
                  try {
                ...
                let o3 = new Set(i4);
                for (let t7 = 0; t7 < e13.length; t7++) {
                  let r6 = e13[t7];
                  if (o3.has(r6)) {
                    let e14 = 0 + 40 * t7;
                    if (a5.distances[r6] = { [r6]: e14 }, e14 < n5 && (n5 = e14, a5.matchedDesiredLocale = r6, a5.matchedSupportedLocale = r6), 0 === t7) return a5;
                  }
                }
                for (let t7 = 0; t7 < e13.length; t7++) {
                  let r6 = e13[t7];
                    ...
                    if (e14 !== r6) {
                      ...
                      for (let s4 = 0; s4 < i5.length; s4++) {
                        ...
                        if (d3 !== r6 && o3.has(d3)) {
                          let i6;
                          try {
                            i6 = new Intl.Locale(d3).maximize().toString() === e14 ? 0 + 40 * t7 : 10 * s4 + 40 * t7;
                          } catch {
                            i6 = 10 * s4 + 40 * t7;
                          }
                ...
                return a5.matchedSupportedLocale && 0 === n5 || (e13.forEach((e14, r6) => {
                  a5.distances[e14] || (a5.distances[e14] = {}), i4.forEach((i5, o4) => {
                    let s4 = t6[o4], d3 = tK(e14, i5) + 0 + 40 * r6;
            ...
            s2 = o2.extension ? function(e13) {
              ...
              for (; i4 < a4; ) {
                ...
                tG(o3 >= 2, "Expected a subtag to have at least 2 characters"), void 0 === t6 && 2 != o3 ? -1 === r4.indexOf(d3) && r4.push(d3) : 2 === o3 ? (t6 = { key: d3, value: "" }, void 0 === n4.find((e14) => e14.key === t6?.key) && n4.push(t6)) : t6?.value === "" ? t6.value = d3 : (tG(void 0 !== t6, "Expected keyword to be defined"), t6.value += "-" + d3), i4 += o3 + 1;
              }
            ...
            for (let e13 of n3) {
              ...
              let i4 = s2.find((t7) => t7.key === e13);
              if (i4) {
                let r4 = i4.value;
                "" !== r4 ? n4.indexOf(r4) > -1 && (t6 = { key: e13, value: a4 = r4 }) : n4.indexOf("true") > -1 && (t6 = { key: e13, value: a4 = "true" });
              }
              let o3 = r3[e13];
              tG(null == o3 || "string" == typeof o3, "optionsValue must be a string or undefined"), "string" == typeof o3 && "" === (o3 = function(e14, t7) {
                let r4 = t7.toLowerCase();
                return tG(void 0 !== e14, "ukey must be defined"), r4;
              }(e13.toLowerCase(), o3)) && (o3 = "true"), o3 !== a4 && n4.indexOf(o3) > -1 && (a4 = o3, t6 = void 0), t6 && _2.push(t6), c2[e13] = a4;
            }
            return _2.length > 0 && (l2 = function(e13, t6, r4) {
              tG(-1 === e13.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
              let n4 = "-u";
              for (let e14 of t6) n4 += `-${e14}`;
              for (let e14 of r4) {
                let { key: t7, value: r5 } = e14;
                n4 += `-${t7}`, "" !== r5 && (n4 += `-${r5}`);
              }
          ...
          }(e11, Intl.getCanonicalLocales(a2), { localeMatcher: "best fit" }, [], {}, () => r2).locale, n2 = t4.find((e12) => e12.toLowerCase() === i2.toLowerCase());
        } catch {
        }
        return n2;
      }
      function tY(e10, t4) {
        if (e10.localeCookie && t4.has(e10.localeCookie.name)) {
          let r2 = t4.get(e10.localeCookie.name)?.value;
          if (r2 && e10.locales.includes(r2)) return r2;
        }
      }
      function tJ(e10, t4, r2, n2) {
        let a2;
        return n2 && (a2 = tN(n2, e10.locales, e10.localePrefix)?.locale), !a2 && e10.localeDetection && (a2 = tY(e10, r2)), !a2 && e10.localeDetection && (a2 = tZ(t4, e10.locales, e10.defaultLocale)), a2 || (a2 = e10.defaultLocale), a2;
      }
      let tQ = (o = { ...J = { locales: ["en", "es", "vi"], defaultLocale: "en", localePrefix: "as-needed" }, localePrefix: "object" == typeof (ee = J.localePrefix) ? ee : { mode: ee || "always" }, localeCookie: !!((Q = J.localeCookie) ?? 1) && { name: "NEXT_LOCALE", sameSite: "lax", ..."object" == typeof Q && Q }, localeDetection: J.localeDetection ?? true, alternateLinks: J.alternateLinks ?? true }, function(e10) {
        var t4, r2;
        let n2;
        try {
        ...
        let a2 = n2.replace(/\\/g, "%5C").replace(/\/+/g, "/"), { domain: i2, locale: s2 } = (t4 = e10.headers, r2 = e10.cookies, o.domains ? function(e11, t5, r3, n3) {
          let a3, i3 = function(e12, t6) {
            let r4 = tL(e12);
            if (r4) return t6.find((e13) => e13.domain === r4);
          }(t5, e11.domains);
          if (!i3) return { locale: tJ(e11, t5, r3, n3) };
          if (n3) {
            let t6 = tN(n3, e11.locales, e11.localePrefix, i3)?.locale;
            if (t6) {
              if (!tI(t6, i3)) return { locale: t6, domain: i3 };
              a3 = t6;
            }
          }
          ...
          if (!a3 && e11.localeDetection) {
            let e12 = tZ(t5, i3.locales, i3.defaultLocale);
            e12 && (a3 = e12);
          }
          return a3 || (a3 = i3.defaultLocale), { locale: a3, domain: i3 };
        }(o, t4, r2, a2) : { locale: tJ(o, t4, r2, a2) }), d2 = i2 ? i2.defaultLocale === s2 : s2 === o.defaultLocale, l2 = o.domains?.filter((e11) => tI(s2, e11)) || [], u2 = null != o.domains && !i2;
        function c2(t5) {
          var r3;
          let n3 = new URL(t5, e10.url);
        ...
        if (b2) {
          let t5;
          if ([t5, m2] = function(e11, t6, r3) {
            for (let n3 of Object.keys(e11).sort(tO)) {
              let a3 = e11[n3];
              if ("string" == typeof a3) {
                if (tv(a3, t6)) return [void 0, n3];
              } else {
                let i3 = Object.entries(a3), o2 = i3.findIndex(([e12]) => e12 === r3);
                for (let [r4] of (o2 > 0 && i3.unshift(i3.splice(o2, 1)[0]), i3)) if (tv(tm(e11[n3], r4, n3), t6)) return [r4, n3];
              }
            }
            for (let r4 of Object.keys(e11)) if (tv(r4, t6)) return [void 0, r4];
        ...
        if (!y2) if ("/" !== v2 || h2) {
          let t5 = tM(v2, `/${s2}`, e10.nextUrl.search);
          if (h2) {
            ...
            if ("never" === o.localePrefix.mode) y2 = _2(tM(p2, void 0, e10.nextUrl.search));
              ...
              y2 = i2?.domain === e11?.domain || u2 ? c2(t5) : _2(r3, e11?.domain);
            } else y2 = c2(t5);
            else y2 = _2(r3);
          } else y2 = g2 ? c2(t5) : _2(tM(p2, tb(s2, o.localePrefix), e10.nextUrl.search));
        } else y2 = g2 ? c2(tM(v2, `/${s2}`, e10.nextUrl.search)) : _2(tM(p2, tb(s2, o.localePrefix), e10.nextUrl.search));
        return function(e11, t5, r3, n3, a3) {
          if (!n3.localeCookie) return;
          let { name: i3, ...o2 } = n3.localeCookie, s3 = e11.cookies.has(i3);
          s3 && e11.cookies.get(i3)?.value !== r3 ? t5.cookies.set(i3, r3, { path: e11.nextUrl.basePath || void 0, ...o2 }) : s3 || tZ(e11.headers, a3?.locales || n3.locales, n3.defaultLocale) === r3 || t5.cookies.set(i3, r3, { path: e11.nextUrl.basePath || void 0, ...o2 });
        }(e10, y2, s2, o, i2), !w2 && "never" !== o.localePrefix.mode && o.alternateLinks && o.locales.length > 1 && y2.headers.set("Link", function({ internalTemplateName: e11, localizedPathnames: t5, request: r3, resolvedLocale: n3, routing: a3 }) {
          let i3 = r3.nextUrl.clone(), o2 = tL(r3.headers);
          function s3(e12, t6) {
            var n4;
            return e12.pathname = tw(e12.pathname), r3.nextUrl.basePath && ((e12 = new URL(e12)).pathname = (n4 = e12.pathname, tw(r3.nextUrl.basePath + n4))), `<${e12.toString()}>; rel="alternate"; hreflang="${t6}"`;
          }
          function d3(r4, a4) {
            return t5 && "object" == typeof t5 ? tT(r4, t5[n3] ?? e11, t5[a4] ?? e11) : r4;
          }
          ...
          let l3 = tP(a3.locales, a3.localePrefix, false).flatMap(([e12, r4]) => {
            ...
            if (a3.domains) return a3.domains.filter((t6) => tI(e12, t6)).map((t6) => ((n4 = new URL(i3)).port = "", n4.host = t6.domain, n4.pathname = d3(i3.pathname, e12), e12 === t6.defaultLocale && "always" !== a3.localePrefix.mode || (n4.pathname = o3(n4.pathname)), s3(n4, e12)));
            {
              let r5;
              r5 = t5 && "object" == typeof t5 ? d3(i3.pathname, e12) : i3.pathname, e12 === a3.defaultLocale && "always" !== a3.localePrefix.mode || (r5 = o3(r5)), n4 = new URL(r5, i3);
            }
            return s3(n4, e12);
          });
          if (!a3.domains || 0 === a3.domains.length) {
            ...
            if (e12) {
              let t6 = new URL(e12, i3);
              l3.push(s3(t6, "x-default"));
            }
          }
          return l3.join(", ");
        }({ routing: o, internalTemplateName: m2, localizedPathnames: null != m2 && b2 ? b2[m2] : void 0, request: e10, resolvedLocale: s2 })), y2;
      });
      e.s(["config", 0, { matcher: ["/((?!api|_next|_vercel|admin|payload|icon-|sw\\.js|worklets|images|media|manifest).*)"] }, "default", 0, tQ], 96592);
      var t0 = e.i(96592);
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let t1 = { ...t0 }, t3 = "/middleware", t2 = t1.middleware || t1.default;
      if ("function" != typeof t2) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${t3}" must export a function named \`middleware\` or a default function.`);
      e.s(["default", 0, (e10) => tg({ ...e10, page: t3, handler: async (...e11) => {
        try {
          return await t2(...e11);
        } catch (a2) {
          let t4 = e11[0], r2 = new URL(t4.url), n2 = r2.pathname + r2.search;
          throw await u(a2, { path: n2, method: t4.method, headers: Object.fromEntries(t4.headers.entries()) }, { routerKind: "Pages Router", routePath: "/proxy", routeType: "proxy", revalidateReason: void 0 }), a2;
        }
      } })], 58217);
    }]);
  }
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next|_vercel|admin|payload|icon-|sw\\.js|worklets|images|media|manifest).*))(\\\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "typescript": { "ignoreBuildErrors": false }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.js", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [], "qualities": [75], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": false, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\dev\\texasprestigemasonry", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 11, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": false, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": false, "lockDistDir": true, "isolatedDevBuild": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.js", "turbopack": { "resolveAlias": { "next-intl/config": "./src/i18n/request.ts" }, "root": "C:\\dev\\texasprestigemasonry" }, "distDirRoot": ".next", "_originalRedirects": [{ "source": "/admin", "destination": "/dashboard", "permanent": false }] };
var BuildId = "fZGAVZB9URoTO7wd8GnJY";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }, { "source": "/admin", "destination": "/dashboard", "statusCode": 307, "regex": "^(?!/_next)/admin(?:/)?$" }], "routes": { "static": [{ "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin/mission-control", "regex": "^/admin/mission\\-control(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/mission\\-control(?:/)?$" }, { "page": "/api/admin/cleanup-duplicates", "regex": "^/api/admin/cleanup\\-duplicates(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/cleanup\\-duplicates(?:/)?$" }, { "page": "/api/places/autocomplete", "regex": "^/api/places/autocomplete(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/places/autocomplete(?:/)?$" }, { "page": "/api/service-requests", "regex": "^/api/service\\-requests(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/service\\-requests(?:/)?$" }, { "page": "/api/square/webhook", "regex": "^/api/square/webhook(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/square/webhook(?:/)?$" }, { "page": "/api/webhooks/ses", "regex": "^/api/webhooks/ses(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/webhooks/ses(?:/)?$" }, { "page": "/app", "regex": "^/app(?:/)?$", "routeKeys": {}, "namedRegex": "^/app(?:/)?$" }, { "page": "/auth/complete", "regex": "^/auth/complete(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/complete(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/dashboard/dispatch", "regex": "^/dashboard/dispatch(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/dispatch(?:/)?$" }, { "page": "/dashboard/emails", "regex": "^/dashboard/emails(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/emails(?:/)?$" }, { "page": "/dashboard/logout", "regex": "^/dashboard/logout(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/logout(?:/)?$" }, { "page": "/dashboard/media", "regex": "^/dashboard/media(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/media(?:/)?$" }, { "page": "/dashboard/posts", "regex": "^/dashboard/posts(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/posts(?:/)?$" }, { "page": "/dashboard/posts/create", "regex": "^/dashboard/posts/create(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/posts/create(?:/)?$" }, { "page": "/dashboard/projects", "regex": "^/dashboard/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/projects(?:/)?$" }, { "page": "/dashboard/projects/create", "regex": "^/dashboard/projects/create(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/projects/create(?:/)?$" }, { "page": "/dashboard/services", "regex": "^/dashboard/services(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/services(?:/)?$" }, { "page": "/dashboard/services/create", "regex": "^/dashboard/services/create(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/services/create(?:/)?$" }, { "page": "/dashboard/settings", "regex": "^/dashboard/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/settings(?:/)?$" }, { "page": "/dashboard/technician", "regex": "^/dashboard/technician(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/technician(?:/)?$" }, { "page": "/dashboard/testimonials", "regex": "^/dashboard/testimonials(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/testimonials(?:/)?$" }, { "page": "/dashboard/testimonials/create", "regex": "^/dashboard/testimonials/create(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/testimonials/create(?:/)?$" }, { "page": "/dashboard/users", "regex": "^/dashboard/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/users(?:/)?$" }, { "page": "/dashboard/users/create", "regex": "^/dashboard/users/create(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/users/create(?:/)?$" }, { "page": "/diagnose", "regex": "^/diagnose(?:/)?$", "routeKeys": {}, "namedRegex": "^/diagnose(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/manifest.webmanifest", "regex": "^/manifest\\.webmanifest(?:/)?$", "routeKeys": {}, "namedRegex": "^/manifest\\.webmanifest(?:/)?$" }, { "page": "/portal", "regex": "^/portal(?:/)?$", "routeKeys": {}, "namedRegex": "^/portal(?:/)?$" }, { "page": "/profile/complete", "regex": "^/profile/complete(?:/)?$", "routeKeys": {}, "namedRegex": "^/profile/complete(?:/)?$" }, { "page": "/signup", "regex": "^/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/signup(?:/)?$" }, { "page": "/technician", "regex": "^/technician(?:/)?$", "routeKeys": {}, "namedRegex": "^/technician(?:/)?$" }], "dynamic": [{ "page": "/api/auth/[...all]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPall": "nxtPall" }, "namedRegex": "^/api/auth/(?<nxtPall>.+?)(?:/)?$" }, { "page": "/api/places/details/[placeId]", "regex": "^/api/places/details/([^/]+?)(?:/)?$", "routeKeys": { "nxtPplaceId": "nxtPplaceId" }, "namedRegex": "^/api/places/details/(?<nxtPplaceId>[^/]+?)(?:/)?$" }, { "page": "/api/[[...route]]", "regex": "^/api(?:/(.+?))?(?:/)?$", "routeKeys": { "nxtProute": "nxtProute" }, "namedRegex": "^/api(?:/(?<nxtProute>.+?))?(?:/)?$" }, { "page": "/dashboard/emails/[id]", "regex": "^/dashboard/emails/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/emails/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/dashboard/posts/[id]", "regex": "^/dashboard/posts/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/posts/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/dashboard/projects/[id]", "regex": "^/dashboard/projects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/projects/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/dashboard/services/[id]", "regex": "^/dashboard/services/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/services/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/dashboard/testimonials/[id]", "regex": "^/dashboard/testimonials/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/dashboard/testimonials/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/[locale]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)(?:/)?$" }, { "page": "/[locale]/about", "regex": "^/([^/]+?)/about(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/about(?:/)?$" }, { "page": "/[locale]/blog", "regex": "^/([^/]+?)/blog(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/blog(?:/)?$" }, { "page": "/[locale]/blog/[slug]", "regex": "^/([^/]+?)/blog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPslug": "nxtPslug" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/blog/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/[locale]/book-service", "regex": "^/([^/]+?)/book\\-service(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/book\\-service(?:/)?$" }, { "page": "/[locale]/contact", "regex": "^/([^/]+?)/contact(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/contact(?:/)?$" }, { "page": "/[locale]/portfolio", "regex": "^/([^/]+?)/portfolio(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/portfolio(?:/)?$" }, { "page": "/[locale]/portfolio/[id]", "regex": "^/([^/]+?)/portfolio/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPid": "nxtPid" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/portfolio/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/[locale]/privacy", "regex": "^/([^/]+?)/privacy(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/privacy(?:/)?$" }, { "page": "/[locale]/services", "regex": "^/([^/]+?)/services(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/services(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/manifest.webmanifest": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "application/manifest+json", "x-next-cache-tags": "_N_T_/layout,_N_T_/manifest.webmanifest/layout,_N_T_/manifest.webmanifest/route,_N_T_/manifest.webmanifest" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/manifest.webmanifest", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "95461608b184ba463dd4555c0e97c6f5", "previewModeSigningKey": "5ec205d30791d506fedf97fa97eb8aea27ebde03d1ecd0ea089608e718e19782", "previewModeEncryptionKey": "e56a3d288d4cf09799336c045bd36c8da4a442749843e91ad75e201a7154152d" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/[root-of-the-server]__cfc6ad0d._.js", "server/edge/chunks/node_modules_340da56f._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_cb46ab6f.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next|_vercel|admin|payload|icon-|sw\\.js|worklets|images|media|manifest).*))(\\\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next|_vercel|admin|payload|icon-|sw\\.js|worklets|images|media|manifest).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "fZGAVZB9URoTO7wd8GnJY", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "4s3Rgdn8wn8YQKR83kV7/cTmcycU0eJsM+63VFlNi88=", "__NEXT_PREVIEW_MODE_ID": "95461608b184ba463dd4555c0e97c6f5", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "e56a3d288d4cf09799336c045bd36c8da4a442749843e91ad75e201a7154152d", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5ec205d30791d506fedf97fa97eb8aea27ebde03d1ecd0ea089608e718e19782" } } }, "sortedMiddleware": ["/"], "functions": { "/api/[[...route]]/route": { "files": ["server/middleware-build-manifest.js", "server/interception-route-rewrite-manifest.js", "required-server-files.js", "server/server-reference-manifest.js", "server/app/api/[[...route]]/route_client-reference-manifest.js", "server/edge/chunks/_next-internal_server_app_api_[[___route]]_route_actions_c664e5d2.js", "server/edge/chunks/[root-of-the-server]__af39e6af._.js", "server/edge/chunks/node_modules_b508db8e._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_cedf7de7.js"], "name": "app/api/[[...route]]/route", "page": "/api/[[...route]]/route", "matchers": [{ "regexp": "^/api(?:/(?P<nxtProute>.+?))?(?:/)?$", "originalSource": "/api/[[...route]]" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "fZGAVZB9URoTO7wd8GnJY", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "4s3Rgdn8wn8YQKR83kV7/cTmcycU0eJsM+63VFlNi88=", "__NEXT_PREVIEW_MODE_ID": "95461608b184ba463dd4555c0e97c6f5", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "e56a3d288d4cf09799336c045bd36c8da4a442749843e91ad75e201a7154152d", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5ec205d30791d506fedf97fa97eb8aea27ebde03d1ecd0ea089608e718e19782" } } } };
var AppPathRoutesManifest = { "/(site)/(public)/[locale]/about/page": "/[locale]/about", "/(site)/(public)/[locale]/blog/[slug]/page": "/[locale]/blog/[slug]", "/(site)/(public)/[locale]/blog/page": "/[locale]/blog", "/(site)/(public)/[locale]/book-service/page": "/[locale]/book-service", "/(site)/(public)/[locale]/contact/page": "/[locale]/contact", "/(site)/(public)/[locale]/page": "/[locale]", "/(site)/(public)/[locale]/portfolio/[id]/page": "/[locale]/portfolio/[id]", "/(site)/(public)/[locale]/portfolio/page": "/[locale]/portfolio", "/(site)/(public)/[locale]/privacy/page": "/[locale]/privacy", "/(site)/(public)/[locale]/services/page": "/[locale]/services", "/(site)/(public)/app/page": "/app", "/(site)/(public)/auth/complete/page": "/auth/complete", "/(site)/(public)/login/page": "/login", "/(site)/(public)/portal/page": "/portal", "/(site)/(public)/profile/complete/page": "/profile/complete", "/(site)/(public)/signup/page": "/signup", "/(site)/admin/mission-control/page": "/admin/mission-control", "/(site)/dashboard/dispatch/page": "/dashboard/dispatch", "/(site)/dashboard/emails/[id]/page": "/dashboard/emails/[id]", "/(site)/dashboard/emails/page": "/dashboard/emails", "/(site)/dashboard/logout/route": "/dashboard/logout", "/(site)/dashboard/media/page": "/dashboard/media", "/(site)/dashboard/page": "/dashboard", "/(site)/dashboard/posts/[id]/page": "/dashboard/posts/[id]", "/(site)/dashboard/posts/create/page": "/dashboard/posts/create", "/(site)/dashboard/posts/page": "/dashboard/posts", "/(site)/dashboard/projects/[id]/page": "/dashboard/projects/[id]", "/(site)/dashboard/projects/create/page": "/dashboard/projects/create", "/(site)/dashboard/projects/page": "/dashboard/projects", "/(site)/dashboard/services/[id]/page": "/dashboard/services/[id]", "/(site)/dashboard/services/create/page": "/dashboard/services/create", "/(site)/dashboard/services/page": "/dashboard/services", "/(site)/dashboard/settings/page": "/dashboard/settings", "/(site)/dashboard/technician/page": "/dashboard/technician", "/(site)/dashboard/testimonials/[id]/page": "/dashboard/testimonials/[id]", "/(site)/dashboard/testimonials/create/page": "/dashboard/testimonials/create", "/(site)/dashboard/testimonials/page": "/dashboard/testimonials", "/(site)/dashboard/users/create/page": "/dashboard/users/create", "/(site)/dashboard/users/page": "/dashboard/users", "/(site)/diagnose/page": "/diagnose", "/(site)/technician/page": "/technician", "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/api/[[...route]]/route": "/api/[[...route]]", "/api/admin/cleanup-duplicates/route": "/api/admin/cleanup-duplicates", "/api/auth/[...all]/route": "/api/auth/[...all]", "/api/places/autocomplete/route": "/api/places/autocomplete", "/api/places/details/[placeId]/route": "/api/places/details/[placeId]", "/api/service-requests/route": "/api/service-requests", "/api/square/webhook/route": "/api/square/webhook", "/api/webhooks/ses/route": "/api/webhooks/ses", "/manifest.webmanifest/route": "/manifest.webmanifest" };
